...
export default function RiseToWar() {
  ...
  const handleZoomChange = useCallback((newZoom) => {
    ...
    setZoom(newZoom);
    // Pan recomputation is handled entirely inside MapRenderer's zoom useEffect,
    // which reads panRef.current (always current) and applies the correct scale offset.
    // Do NOT call setPanSt here — it would fire the panSt effect on top of the zoom
    // effect and snap world.x/y to a stale value, causing the camera shake on zoom.
  }, []);
