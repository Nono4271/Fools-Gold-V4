...
export default function RiseToWar() {
  ...
  const [cmds,   setCmds]    = useState(() => HDEFS.filter(h => h.faction==="pirates").map((h,i) => ({...h, uid:`p${i}`, owner:"player", troops:0, troopType:null, tk:`${HQP.player.c},${HQP.player.r}`, lvl:5, xp:0, respectPoints:0, respectLevel:0, skillPoints:{}, unspentSkillPoints:0, gear:{helmet:null,armor:null,bracers:null,accessory:null}}));
        ...
        cmdResults.forEach(h => {
          ...
          if (!existing) {
            nx.push({ ...h, uid:h.uid, troops:0, troopType:null, tk:hqk, owner:"player", lvl:5, xp:0,
              respectPoints:0, respectLevel:0, skillPoints:{}, unspentSkillPoints:0,
