      ...
      setReinMarches(prev => {
        ...
        prev.forEach(rm => {
          ...
          if (!rm.returning) {
            ...
            const cmdGone    = !targetCmd || (targetCmd.troops === 0 && !targetCmd.march);
            ...
            if (cmdGone || tileFlipped) {
              ...
              // No return path → troops are simply lost (disconnected map edge case)
          ...
          if (nextStep >= rm.path.length) {
            if (rm.returning) {
              ...
              // Arrived — cap to command capacity so troops don't exceed the commander's limit
