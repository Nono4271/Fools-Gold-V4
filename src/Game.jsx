...
export default function RiseToWar() {
  ...
  useEffect(() => {
    if (screen==="game" && Object.keys(tiles).length===0) {
      const rawMap = genMap();
      const spawnKeys = rawMap.__spawnKeys || {};
      delete rawMap.__spawnKeys;
      ...
      // Primary AI faction key (first opponent of opposite alignment)
      ...
      // Move all commanders from placeholder "1,1" to their actual HQ spawn keys
