...
function drawTile(gfx, tile, selKey, mode, hasCmds, mvCmdUid, zoom = 1) {
  ...
  // 1px matching stroke seals sub-pixel gaps between adjacent wall polygons (prevents hatch pattern)
  gfx.lineStyle(1, lWc, 1); gfx.beginFill(lWc); gfx.drawPolygon(LW); gfx.endFill(); gfx.lineStyle(0);
  gfx.lineStyle(1, rWc, 1); gfx.beginFill(rWc); gfx.drawPolygon(RW); gfx.endFill(); gfx.lineStyle(0);
  if (owner) {
  ...
  if (isWin && !owner) {
    ...
    // 1px stroke matching fill seals sub-pixel gaps between adjacent tile top faces
    gfx.lineStyle(1, v.ul, 1); gfx.beginFill(v.ul); gfx.drawPolygon(TUL); gfx.endFill(); gfx.lineStyle(0);
    gfx.lineStyle(1, v.ur, 1); gfx.beginFill(v.ur); gfx.drawPolygon(TUR); gfx.endFill(); gfx.lineStyle(0);
    gfx.lineStyle(1, v.ll, 1); gfx.beginFill(v.ll); gfx.drawPolygon(TLL); gfx.endFill(); gfx.lineStyle(0);
    gfx.lineStyle(1, v.lr, 1); gfx.beginFill(v.lr); gfx.drawPolygon(TLR); gfx.endFill(); gfx.lineStyle(0);
    if (!owner) {
