...
function buildKeepLayer(keepCont, tiles, selKey, onKeepClick, PIXI) {
  ...
  for (const reg of KEEP_REGION_LIST) {
    ...
    // TW=80, TH=40, R=5. Convex hull of all tile corners in the square footprint:
    //   top:    (bx,      worldCY - 200)
    //   right:  (bx+440,  worldCY +  20)
    //   bottom: (bx,      worldCY + 240)
    //   left:   (bx-440,  worldCY +  20)
    const gy = worldCY;
    const FOOTPRINT = [
       bx,        gy - 200,  // top
       bx + 440,  gy +  20,  // right
    ...
    hit.drawRect(bx - 440, gy - 200, 880, 440); // bounding rect for display object
    hit.endFill();
