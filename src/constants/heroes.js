...
export const HDEFS = [
  ...
  { id:"h25", n:"Ironjaw Reck",      faction:"pirates",        rarity:"champion", cls:"attacker", atk:175, foc:0,   spd:90, icon:"💀"  },
  { id:"h26", n:"Navigator Seyne",   faction:"pirates",        rarity:"champion", cls:"leader",   atk:110, foc:60,  spd:80, icon:"🧭"  },
  ...
  { id:"h27", n:"Bulwark Trane",     faction:"marines",        rarity:"champion", cls:"defender", atk:130, foc:0,   spd:62, icon:"🏰"  },
  { id:"h28", n:"Tactician Orel",    faction:"marines",        rarity:"champion", cls:"support",  atk:70,  foc:160, spd:74, icon:"📋"  },
  ...
  { id:"h29", n:"Archmage Thessaly", faction:"bountyhunters",  rarity:"champion", cls:"support",  atk:40,  foc:210, spd:65, icon:"🌟"  },
  { id:"h30", n:"Spellblade Ryn",    faction:"bountyhunters",  rarity:"champion", cls:"attacker", atk:155, foc:130, spd:72, icon:"⚡"  },
  ...
  { id:"h31", n:"Abyssal Thren",     faction:"merfolk",        rarity:"champion", cls:"attacker", atk:165, foc:0,   spd:80, icon:"🦑"  },
  { id:"h32", n:"Tidecaller Mara",   faction:"merfolk",        rarity:"champion", cls:"defender", atk:120, foc:40,  spd:58, icon:"🧜"  },
  ...
  { id:"h33", n:"Warlord Korgath",   faction:"orcs",           rarity:"champion", cls:"attacker", atk:185, foc:0,   spd:62, icon:"🗡"  },
  { id:"h34", n:"Ironhide Bruk",     faction:"orcs",           rarity:"champion", cls:"defender", atk:140, foc:0,   spd:55, icon:"🦴"  },
  ...
  { id:"h35", n:"Pyrewing Skar",     faction:"dragons",        rarity:"champion", cls:"attacker", atk:180, foc:0,   spd:78, icon:"🌋"  },
  { id:"h36", n:"Voidscale Nyxara",  faction:"dragons",        rarity:"champion", cls:"support",  atk:60,  foc:175, spd:82, icon:"🌑"  },
];
