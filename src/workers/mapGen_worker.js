...
function buildLookups() {
  ...
  for (let r=0;r<ROWS;r++) for (let c=0;c<COLS;c++) {
    ...
    // Southern border: tiles not in any region that are south of the playable area.
    // Uses corridor-aware logic: full-width below SVG y=605, plus left/right flanks
    // below SVG y=460 (outside the central runemarks/boneridge/holyGrail corridor x=230-470).
