...
const REGION_LIST = [
  { key:"holyGrail",         name:"The Holy Grail",          layer:"ring",     keepName:"The Holy Grail",               cx:350, cy:408 },
  { key:"shatteredShallows", name:"The Shattered Shallows",  layer:"conflict", keepName:"The Shattered Shallows Keep",  cx:342, cy:234 },
  { key:"bloodmarch",        name:"Bloodmarch",               layer:"conflict", keepName:"Bloodmarch Keep",              cx:429, cy:418 },
  { key:"ashenRift",         name:"The Ashen Rift",           layer:"conflict", keepName:"The Ashen Rift Keep",          cx:271, cy:418 },
  { key:"brinefields",       name:"Brinefields",              layer:"farm",     keepName:"Brinefields Keep",             cx:158, cy:181 },
  { key:"coralfen",          name:"Coralfen",                 layer:"farm",     keepName:"Coralfen Keep",                cx:510, cy:176 },
  { key:"stormwatch",        name:"Stormwatch",               layer:"farm",     keepName:"Stormwatch Keep",              cx:595, cy:420 },
  { key:"boneridge",         name:"Boneridge",                layer:"farm",     keepName:"Boneridge Keep",               cx:423, cy:548 },
  { key:"runemarks",         name:"Runemarks",                layer:"farm",     keepName:"Runemarks Keep",               cx:277, cy:548 },
  ...
  { key:"ironhaven",         name:"Ironhaven",                layer:"start",    keepName:"Ironhaven Keep",               cx:622, cy:251, factions:["marines"]        },
  { key:"grimhold",          name:"Grimhold",                 layer:"start",    keepName:"Grimhold Keep",                cx:552, cy:555, factions:["orcs"]           },
  { key:"ashenveil",         name:"Ashenveil",                layer:"start",    keepName:"Ashenveil Keep",               cx:140, cy:565, factions:["bountyhunters"]  },
  { key:"emberpeak",         name:"Emberpeak",                layer:"start",    keepName:"Emberpeak Keep",               cx:103, cy:255, factions:["dragons"]        },
];
...
function buildLookups() {
  ...
  for (let r=0;r<ROWS;r++) for (let c=0;c<COLS;c++) {
    ...
    // Southern border mountains: corridor-aware (avoids marking center gaps as mountains)
    // plus hard cutoff at row 600 to cover southern edges of ashenveil/grimhold/cinderplain/stormwatch
    if (!found && (sy > 605 || (sy > 460 && (sx < 230 || sx > 470)))) BORDER_MAP[r*COLS+c] = 1;
    if (r > 600) BORDER_MAP[r*COLS+c] = 1;
  }
