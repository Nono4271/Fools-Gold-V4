                  ...
                  <div style={{ display: "flex", gap: 4, marginBottom: 8, flexWrap: "wrap" }}>
                    {Array.from({ length: 10 }).map((_, i) => (
                      <div key={i} style={{
                        ...
                        fontSize: 8, color: "#4a3a2a", fontFamily: "'Cinzel',serif",
                        position: "relative",
                      }}>
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", position: "relative", minHeight: 0 }}>
      ...
      {classDef && (
        <div style={{
          margin: "10px 14px 0",
          padding: "7px 10px",
          background: `${rarityDef.color}08`,
          border: `1px solid ${rarityDef.color}25`,
          borderRadius: 5,
          flexShrink: 0,
        }}>
          <div style={{ fontSize: 7, color: rarityDef.color, fontFamily: "'Cinzel',serif",
            letterSpacing: ".08em", marginBottom: 3 }}>
            {classDef.icon} CLASS BONUS {lvl >= 25 ? "(ACTIVE)" : `(unlocks at Lv25)`}
          </div>
          <div style={{ fontSize: 9, color: lvl >= 25 ? "#c0b090" : "#4a4a4a",
...
// ── Main export ───────────────────────────────────────────────────────────────
export default function CommanderTab({ cmds, bldgs, tiles, recallMarch, setHqTab, setHqOpen, setScreen }) {
