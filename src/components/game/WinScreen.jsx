...
export default function WinScreen({ winner, aiFaction, setWinner, setTiles, setCmds, setMode, setSelKey, setUpgQueue, setBldgs, setBarracks, setAiRss, setAiBldgs, setAiBarracksPool, aiLastActionRef, setScreen, setWounded, setWoundedQueue, setRss, setReinMarches, setTrainingQueue, setBLog, setBattles, setUnseenBattles, setDeletingTiles, setDeletingSecsLeft }) {
    ...
    <div style={{position:"fixed",inset:0,zIndex:10000,background:"rgba(0,0,0,.85)",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:16,padding:24}}>
      ...
      <div style={{display:"flex",gap:12,flexWrap:"wrap",justifyContent:"center"}}>
        <button className="btn" onClick={() => {
          ...
          setWounded(0);
          setWoundedQueue(0);
          // Fix: reset state that was previously leaking into new games
