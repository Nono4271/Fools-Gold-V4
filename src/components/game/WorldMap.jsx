  ...
  return (
    <div style={{
      ...
      <div style={{ flex:1, overflow:"hidden", position:"relative" }}>
        <svg viewBox={`0 0 ${DW} ${DH}`} preserveAspectRatio="xMidYMid meet"
          ...
          <text x={DW/2} y={(DH-10)*sy} textAnchor="middle"
          ...
          <rect width={DW} height={46} fill="rgba(0,0,0,0.75)"/>
          <line x1={0} y1={46} x2={DW} y2={46} stroke="rgba(200,160,64,0.25)" strokeWidth={1}/>
          <text x={DW/2} y={29} textAnchor="middle" fontSize={15}
