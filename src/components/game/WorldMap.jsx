...
import { worldMapScale, ICON_SCALE, HIT_PAD } from "../../constants/device.js";
...
export default function WorldMap({ tiles, onClose, onTeleport, panSt, zoom }) {
  ...
  // Scale by height to fill screen vertically; map wider than screen is fine (centered/clipped)
  const scale  = worldMapScale(screenW, screenH, DW, DH);
  ...
  return (
    <div style={{
      ...
      <div style={{ flex:1, overflow:"hidden", position:"relative", display:"flex", justifyContent:"center" }}>
        <svg width={mapW} height={mapH} style={{ display:"block", flexShrink:0 }}>
          <defs>
            <filter id="wm-drop">
