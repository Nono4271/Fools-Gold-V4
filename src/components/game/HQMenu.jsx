...
import { RC, RARITY, CLASS, respectCost, RESPECT_MAX } from "../../constants/heroes.js";
const SC = RC;
const SS = (r) => RARITY[r]?.n ?? String(r);

export default function HQMenu({
  hqOpen, setHqOpen, hqTab, setHqTab,
  cmds, setCmds, tiles, rss, gems, pKeys,
  bldgs, barracksPool, setBarracks, woundedTroops,
    ...
    <div style={{position:"fixed",inset:0,zIndex:400,background:"rgba(0,0,0,.75)",display:"flex",alignItems:"flex-end"}}
      ...
      <div className="panel" onClick={e => e.stopPropagation()}
        ...
        <div className="scr" style={{
          flex:1,
          overflowY: hqTab==="commanders" ? "hidden" : "auto",
          padding: hqTab==="commanders" ? 0 : 12,
          display: hqTab==="commanders" ? "flex" : "block",
