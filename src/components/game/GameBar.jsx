...
export default function GameBar({
  ...
  // Only show commanders that are actively marching (not sitting in HQ)
  const playerCmds = cmds
    .filter(c => c.owner === "player" && c.march != null)
    .sort((a, b) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* ── Left: Marching commander portraits (only shown when not in HQ) ── */}
        <div style={{
