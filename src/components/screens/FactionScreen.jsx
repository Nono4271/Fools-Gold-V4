...
import { HDEFS, SC } from "../../constants/heroes.js";
              ...
              return (
                <button key={f.key} className="btn"
                  onClick={() => {
                    ...
                    const startCmds = starters.map((h,i) => ({...h, uid:`p${i}`, owner:"player", troops:0, troopType:null, tk:hqk, lvl:5, xp:0, respectPoints:0, respectLevel:0, skillPoints:{}, unspentSkillPoints:0, gear:{helmet:null,armor:null,bracers:null,accessory:null}}));
                    ...
                    const aiCmds = aiStarters.map((h,i) => ({...h, uid:`ai${i}`, owner:"ai", troops:0, troopType:null, tk:AI_HQ_KEY, lvl:5, xp:0, respectPoints:0, respectLevel:0, skillPoints:{}, unspentSkillPoints:0, gear:{helmet:null,armor:null,bracers:null,accessory:null}}));
                    setFacKey(f.key);
                    setFacName(f.n);
                    setAiFaction(aiFk);
