...
import {
  RARITY, CLASS, SKILL_TREES, getSkillNames,
        ...
        {Object.entries(SKILL_TREES).map(([treeKey, tree]) => {
          ...
          return (
            <div key={treeKey} style={{
              ...
              border: `1px solid ${locked ? "#1c1c1c" : rarityDef.color + "30"}`,
              ...
              <div style={{
                padding: "10px 14px",
                background: locked ? "transparent" : `linear-gradient(90deg, ${rarityDef.color}10, transparent)`,
                borderBottom: `1px solid ${locked ? "#181818" : rarityDef.color + "18"}`,
                display: "flex", alignItems: "center", gap: 10,
              }}>
                <span style={{ fontSize: 18 }}>{tree.icon}</span>
                <div style={{ flex: 1 }}>
                  <div style={{ fontFamily: "'Cinzel',serif", fontSize: 11, fontWeight: 700,
                    color: locked ? "#333" : "#e0d0c0" }}>{tree.n}</div>
                ...
                {locked
                  ? <div style={{ padding: "2px 8px", borderRadius: 3, border: "1px solid #cc303040",
                      fontSize: 8, color: "#cc3030", fontFamily: "'Cinzel',serif" }}>🔒 R{tree.unlocksAt}</div>
              ...
              {!locked && (
                <div style={{ padding: "12px 14px" }}>
                  ...
                  <div style={{ fontSize: 7, color: "#5a4a2a", fontFamily: "'Cinzel',serif",
                    letterSpacing: ".08em", marginBottom: 7 }}>MAIN BRANCH — max 10 pts</div>
                  <div style={{ display: "flex", gap: 5, marginBottom: 12, flexWrap: "wrap" }}>
                    {Array.from({ length: 10 }).map((_, i) => (
                      <div key={i} style={{
                        ...
                        display: "flex", alignItems: "center", justifyContent: "center",
                        fontSize: 8, color: "#3a2a1a", fontFamily: "'Cinzel',serif",
                    ...
                    {[0, 1].map(sub => (
                      <div key={sub}>
                        <div style={{ fontSize: 7, color: "#4a3a2a", fontFamily: "'Cinzel',serif",
                          ...
                          {names[sub] ?? `Sub-branch ${sub + 1}`} — max 5
                        </div>
...
function CommanderDetail({ cmd, bldgs, gearInventory, setGearInventory, respectSchematics, setCmds, onSchematicUsed }) {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={label} style={{
            ...
            <div style={{ fontFamily: "'Cinzel',serif", fontSize: 16, fontWeight: 700, color }}>{val}</div>
            <div style={{ fontSize: 7, color: "#3a3020", fontFamily: "'Cinzel',serif",
              letterSpacing: ".07em", marginTop: 4 }}>{label}</div>
          </div>
        ))}
      </div>
      ...
      {cls && (
        <div style={{
          margin: "12px 18px 0", padding: "8px 12px", flexShrink: 0,
          ...
          <div style={{ fontSize: 7, color: r.color, fontFamily: "'Cinzel',serif",
            ...
            {cls.icon} CLASS BONUS{lvl >= 25 ? " — ACTIVE" : ` — unlocks Lv25`}
          </div>
          <div style={{ fontSize: 9, fontFamily: "'Crimson Pro',serif",
            color: lvl >= 25 ? "#b0a080" : "#3a3020" }}>{cls.bonus}</div>
        </div>
      )}
              ...
              {["helmet","armor","bracers","accessory"].map(slotKey => {
                ...
                return (
                  <div key={slotKey} style={{
                    ...
                    <div style={{ fontSize: piece ? 18 : 14, marginBottom: 3, opacity: piece ? 1 : 0.3 }}>
