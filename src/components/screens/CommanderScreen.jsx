    ...
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "12px 16px", display: "flex", flexDirection: "column", gap: 10 }}>
        {(() => {
          ...
          // Show 3 primary trees + 1 secondary (deduplicated display)
          const treesToShow = [primary[0], "secondary_" + secondary];
          const treeEntries = [
            [primary[0], SKILL_TREES[primary[0]], true],
            [secondary, SKILL_TREES[secondary], false],
          ];
          return treeEntries.map(([treeKey, tree, isPrimary]) => {
            if (!tree) return null;
            ...
            return (
              <div key={treeKey + (isPrimary ? "_primary" : "_secondary")} style={{
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 3 }}>
                    {isPrimary
                      ? <div style={{ padding: "2px 8px", borderRadius: 3,
                          ...
                          fontSize: 7, color: rarityDef.color, fontFamily: "'Cinzel',serif" }}>CLASS TREE ×3</div>
                      : <div style={{ padding: "2px 8px", borderRadius: 3, border: "1px solid #3a3010",
                          fontSize: 7, color: "#6a5a30", fontFamily: "'Cinzel',serif" }}>SECONDARY</div>
                    }
                    {locked
                      ? <div style={{ padding: "2px 8px", borderRadius: 3, border: "1px solid #cc303040",
                          fontSize: 7, color: "#cc3030", fontFamily: "'Cinzel',serif" }}>🔒 R{tree.unlocksAt}</div>
