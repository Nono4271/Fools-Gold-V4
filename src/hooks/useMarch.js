...
const newAtk = Math.round(((cmd.atk || 0) + growth.atk * levelsGained) * 10) / 10;
const newFoc = Math.round(((cmd.foc || 0) + growth.foc * levelsGained) * 10) / 10;
const newSpd = Math.round(((cmd.spd || 0) + growth.spd * levelsGained) * 10) / 10;
